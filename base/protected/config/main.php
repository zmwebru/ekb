...
require_once __DIR__ . "/../components/Exchanger.php";
...
return [
    ...
    'import' => [
        ...
        'application.modules.dictionary.models.*',
    ...
    'components' => [
         ...
         */
        'db' => file_exists(__DIR__ . '/../../config/db.php') ? require_once __DIR__ . '/../../config/db.php' : require_once DB_PATH,
        ...
        'urlManager' => [
            ...
            'rules' => [ // Main rules
				...
				'/callbackSendForm' => 'site/callbackSendForm',
                ...
                '/backend/<action:(AjaxFileUpload|AjaxImageUpload|AjaxImageUploadCKE|index|settings|flushDumpSettings|modulesettings|saveModulesettings|themesettings|modupdate|help|ajaxflush|transliterate|saveTest)>' => '/yupe/backend/<action>',
		...
		// 'Exchanger' => [
			// 'class' => 'application\components\Exchanger'
		// ],
    ],
    /**

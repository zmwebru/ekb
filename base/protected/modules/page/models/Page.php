...
class Page extends yupe\models\YModel
{
    ...
    public function rules()
    {
        return [
            ...
            ['title, title_short, slug, body, description, keywords, seo_title', 'filter', 'filter' => 'trim'],
            ['title, title_short, slug, description, keywords, seo_title', 'filter', 'filter' => [new YPurifier(), 'purify']],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'seo_title' => Yii::t('PageModule.page', 'SEO title (SEO)'),
    ...
    public function attributeDescriptions()
    {
        return [
            ...
            'seo_title' => Yii::t('PageModule.page', 'Max length 1024 symbols'),
            'status' => Yii::t(
                'PageModule.page',
    ...
    public function search()
    {
        ...
        $criteria->compare('seo_title', $this->seo_title);

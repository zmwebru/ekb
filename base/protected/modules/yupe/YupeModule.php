...
class YupeModule extends WebModule
{
    ...
    public function getParamsLabels()
    {
        return [
			...
			'meta' => Yii::t('YupeModule.yupe', 'Extra meta tags'),
			'metrika' => Yii::t('YupeModule.yupe', 'Footer metrika'),
			
			'phone1' => Yii::t('YupeModule.yupe','phone1'),
			'phone2' => Yii::t('YupeModule.yupe','phone2'),
			'phone3' => Yii::t('YupeModule.yupe','phone3'),
			'map' => Yii::t('YupeModule.yupe','map'),
			
			'siteCity' => Yii::t('YupeModule.yupe','siteCity'),
			'address' => Yii::t('YupeModule.yupe','address'),
			'zip' => Yii::t('YupeModule.yupe','zip'),
			'email2' => Yii::t('YupeModule.yupe','email2'),
			'social_vk' => Yii::t('YupeModule.yupe','social_vk'),
			'social_facebook' => Yii::t('YupeModule.yupe','social_facebook'),
			'social_youtube' => Yii::t('YupeModule.yupe','social_youtube'),
			'social_instagram' => Yii::t('YupeModule.yupe','social_instagram'),
			'schedule' =>  Yii::t('YupeModule.yupe','schedule'),

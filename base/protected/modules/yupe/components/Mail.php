...
class Mail extends CApplicationComponent
{
    ...
    public function init()
    {
		...
		$this->smtp = require MAIL_SETTINGS;
        ...
        switch ($this->method) {
            case 'smtp':
                ...
                if (!empty($this->smtp['username'])) {
					...
					$exploded = explode('@', $this->smtp['username']);
					// $this->_mailer->Username = $this->smtp['host'] == 'smtp.yandex.ru' ?  array_shift($exploded) : $this->smtp['username'];
